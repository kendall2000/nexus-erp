//funciones javascript y validaciones
	...
	function printTable(codigo){
		...
		request.open("POST", "ajax_fns_departamento.php");
		request.send(http);
			...
			if(request.status === 200){
				...
				$('#tabla').DataTable({
					...
					buttons: [
						{extend: 'copy'},
						{extend: 'csv'},
						{extend: 'excel', title: 'Tabla de Departamentos'},
						{extend: 'pdf', title: 'Tabla de Departamentos'},
						{extend: 'print',
	...
	function deshabilitarDepartamento(codigo){
		swal({
			title: "\u00BFEsta Seguro?",
			text: "\u00BFDesea quitar a este departamento del listado?, no prodr\u00E1 ser usado despu\u00E9s...",
			icon: "warning",
			buttons: {
				cancel: "Cancelar",
				ok: { text: "Aceptar", value: true,},
