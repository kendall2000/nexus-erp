...
function detalle(codigo) {
    cerrar();
    //Realiza una peticion de contenido a la contenido.phpsss
    $.post("promts/risk/detalle.php", { codigo: codigo }, function (data) {
...
function detalle_oportunidad(codigo) {
    cerrar();
    //Realiza una peticion de contenido a la contenido.php
    $.post("promts/risk/detalle_oportunidad.php", { codigo: codigo }, function (data) {
        // Ponemos la respuesta de nuestro script en el DIV recargado
        $("#Pcontainer").html(data);
    });
    abrirModal();
