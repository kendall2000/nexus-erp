//funciones javascript y validaciones
	...
	function printTable(codigo){
		...
		request.open("POST", "ajax_fns_tipo_recursos.php");
		request.send(http);
			...
			if(request.status === 200){
				...
				$('#tabla').DataTable({
					...
					buttons: [
						{extend: 'copy'},
						{extend: 'csv'},
						{extend: 'excel', title: 'Tabla de Clasificaci\u00F3n de Recursos'},
						{extend: 'pdf', title: 'Tabla de Clasificaci\u00F3n de Recursos'},
						{extend: 'print',
							...
							}, title: 'Tabla de Clasificaci\u00F3n de Recursos'
						}
					]
				});
			}
	...
	function seleccionarTipo(codigo){
		contenedor = document.getElementById("result");
		loadingCogs(contenedor);
		/////////// POST /////////
		var http = new FormData();
	...
	function deshabilitarTipo(codigo){
		swal({
			title: "\u00BFEsta Seguro?",
			text: "\u00BFDesea quitar a esta clasificaci\u00F3n de recursos del listado?, no prodr\u00E1 ser usada despu\u00E9s...",
			icon: "warning",
			buttons: {
				cancel: "Cancelar",
				ok: { text: "Aceptar", value: true,},
