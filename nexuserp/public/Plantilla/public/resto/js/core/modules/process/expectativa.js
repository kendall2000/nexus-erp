...
function printTable() {
    ...
    http.append("request", "tabla_necesidades_expectativas");
...
function Seleccionar(codigo) {
    ...
    /////////// POST /////////
    var http = new FormData();
    http.append("request", "seleccionar");
...
function Grabar() {
    ...
    if (nombre.value !== "" && tipo.value !== "" && comentario.value !== "") {
        /////////// POST /////////
...
function Modificar() {
    ...
    if (codigo.value !== "" && nombre.value !== "" && tipo.value !== "" && comentario.value !== "") {
        /////////// POST /////////
