...
function comprueba_extension(archivo, tipo) {
	...
	if (!archivo) {
		...
		switch (tipo) {
			...
			case 3:
				if (".txt" === extension || ".pdf" === extension || ".jpg" === extension || ".jpeg" === extension || ".png" === extension || ".xlsx" === extension || ".xlsm" === extension || ".xlsb" === extension || ".xltx" === extension || ".xltm" === extension || ".xls" === extension || ".xlt" === extension || ".xml" === extension || ".xlam" === extension || ".xla" === extension || ".xlw" === extension || ".xlr" === extension || ".prn" === extension || ".csv" === extension || ".dif" === extension || ".slk" === extension || ".docx" === extension || ".docm" === extension || ".dotx" === extension || ".dotm" === extension ) return 1;
		}
	}
	return 0;
}
