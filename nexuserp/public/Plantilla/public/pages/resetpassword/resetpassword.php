...
function obtenerURLActual() {
    ...
    $host = $_SERVER['HTTP_HOST']; // Obtiene el host
    $uri = $_SERVER['REQUEST_URI']; // Obtiene la ruta y la query string

    // Construye la URL completa
    $urlCompleta = $protocolo . "://" . $host . $uri;
...
if (isset($_GET['path'])) {
    $path = $_GET['path'];
    $url = ($path == 'Desarrollo') ? "$server/Desarrollo/login" : (($path == 'Vertical') ? "$server/General/login" : '');
} else {
    $url = "$server/General/login";
}
?>
...
<head>
    ...
    <base href="<?php echo $server; ?>/General/FrontEnd/Plantilla/public/pages/authentication/">
    <!-- ===============================================-->
    <!--    Document Title-->
    <!-- ===============================================-->
    <title><?php echo obtenerURLActual();?></title>
                        ...
                        <div class="row align-items-center gx-0 gy-7">
                            <div class="col-auto bg-100 dark__bg-1100 rounded-3 position-relative overflow-hidden auth-title-box">
                                ...
                                <div class="position-relative px-4 px-lg-7 pt-7 pb-7 pb-sm-5 text-center text-md-start pb-lg-7">
                                    <h3 class="mb-3 text-black fs-1">Autenticacion Usuario</h3>
                                    <p class="text-700">Sigue las instrucciones para establecer una nueva contraseña. ¡Listo, tu contraseña estará actualizada!</p>
                                    <ul class="list-unstyled mb-0 w-max-content w-md-auto mx-auto">
                                        <li class="d-flex align-items-center"><span class="uil uil-check-circle text-success me-2"></span><span class="text-700 fw-semi-bold">Rapida</span></li>
                                        ...
                                        <li class="d-flex align-items-center"><span class="uil uil-check-circle text-success me-2"></span><span class="text-700 fw-semi-bold">Sensible</span></li>
                                    </ul>
                                </div>
                            ...
                            <div class="col mx-auto">
                                <div class="auth-form-box">
                                    <div class="text-center mb-7"><a class="d-flex flex-center text-decoration-none mb-4" href="../../index.html">
                                            <div class="d-flex align-items-center fw-bolder fs-5 d-inline-block"><img src="https://cursosprogramacion.s3.us-east-2.amazonaws.com/LogosCursos/logo2-500.png" alt="phoenix" width="120" />
                                            </div>
                                        </a>
                                        <h4 class="text-1000">Restablecer nueva contraseña</h4>
                                        <p class="text-700">Escribe tu nueva contraseña</p>
                                    </div>
                                    <form class="mt-5">
                                        <input class="form-control mb-2" id="password" type="password" placeholder="Nueva contraseña" />
                                        <input class="form-control mb-4" id="confirmPassword" type="password" placeholder="Cofirmar nueva contraseña" />
                                        <button class="btn btn-primary w-100" type="submit">Cambia contraseña</button>
                                    </form>
                                </div>
                            </div>
                        </div>
...
<div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
    ...
    <div class="offcanvas-body scrollbar px-card" id="themeController">
        ...
        <div class="setting-panel-item">
            ...
            <div class="row gx-2">
                <div class="col-6">
                    <input class="btn-check" id="navbarPositionVertical" name="navigation-type" type="radio" value="vertical" data-theme-control="phoenixNavbarPosition" data-page-url="../../documentation/layouts/General-navbar.html" />
        ...
        <div class="setting-panel-item">
            ...
            <div class="row gx-2">
                ...
                <div class="col-6">
                    ...
                    <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-dark"> <img class="img-fluid img-prototype d-dark-none" src="../../assets/img/generic/General-darker.png" alt="" /><img class="img-fluid img-prototype d-light-none" src="../../assets/img/generic/General-lighter.png" alt="" /><span class="label-text d-dark-none"> Darker</span><span class="label-text d-light-none">Lighter</span></label>
                </div>
            </div>
        </div>
        <div class="setting-panel-item">
